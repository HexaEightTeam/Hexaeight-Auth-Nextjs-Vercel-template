...
const cookiedomain = process.env.cookiedomain || '.' + process.env.NEXT_PUBLIC_VERCEL_GIT_REPO_SLUG  + '.vercel.app';
const emaildomainsfilter = process.env.emaildomainsfilter || 'NO';
const emaildomainslist = process.env.emaildomainslist || "";
const servername = process.env.servername || process.env.NEXT_PUBLIC_VERCEL_GIT_REPO_SLUG  + '.vercel.app';
